...
3. Complete the challenge in your fork
4. Submit your fork URL at [adaptrix.ai/careers/challenge](https://adaptrix.ai/careers/challenge)

> ⚠️ **Important:** Do NOT create pull requests to this repo. Work in your own fork.
...
2. Ensure all tests pass: `pytest tests/python/` and `npm test`
3. Generate `output/matched_bounds.json` with your results
4. Add a brief explanation of your approach in the section below
5. **Commit and push to YOUR fork**
6. Submit your fork URL at [adaptrix.ai/careers/challenge](https://adaptrix.ai/careers/challenge)
